...
const BehanceList = () => {
  return (
    <section>
      <div className="container-fluid px-4 pt-10 pb-10">
        <div className="grid md:grid-cols-3 lg:grid-cols-5 sm:grid-cols-2 gap-3 pt-20">
          {behanceItem.map((item, index) => ( // Added 'index' parameter
            <div className="category-item cursor-pointer" key={index}> {/* Added 'key' prop */}
